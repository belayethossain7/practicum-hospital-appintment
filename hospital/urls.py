...
urlpatterns = [
    ...
    path('home/slots/', views.hospital_home_slots, name='hospital-home-slots'),
    path('home/specializations/', views.hospital_home_specializations, name='hospital-home-specializations'),
    path('home/doctors/', views.hospital_home_doctors, name='hospital-home-doctors'),
    path('home/available-slots/', views.hospital_home_available_slots, name='hospital-home-available-slots'),
    path('hospital-branch/<int:pk>/doctors/', views.hospital_branch_doctors, name='hospital-branch-doctors'),
    ...
    path('my-lab-reports/', views.patient_lab_reports, name='patient-lab-reports'),
