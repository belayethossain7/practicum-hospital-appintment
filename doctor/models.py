...
class Doctor_Information(models.Model):
    ...
    # Optional: doctor can be appointed to multiple hospitals (admin-controlled).
    # Keep `hospital_name` as the primary hospital for backwards compatibility across templates.
    appointed_hospitals = models.ManyToManyField(
